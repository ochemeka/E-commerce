						...
						<div class="shop-product-view">
							...
							<div class="shop-category-image">
                                    <div class="featured-product-area">
                                            ...
                                            <img  src="<?php echo SITE_PATH; ?>img/banner/call_s.jpg"  oncontextMenu = "return false" alt="banner">
                                            </div>
                                     </div>
							</div>
			...
			<div class="container">
				<div class="row">
					...
					<div class="single-services-icon">
										<img src="<?php echo SITE_PATH; ?>img/banner/placing-order.png" alt="toop">
									</div>
									<div class="single-services-content">
										<h2 style="color:#000000;">Place Order</h2>
										
										<div class="subscribe-action">
										<a href="<?php echo SITE_PATH; ?>place_order.php" >  	<button class="btn custom-button" name="login" type="submit">Discover more</button></a>
				...
				<!--						-->
					...
					<div class="single-services-icon">
										<img src="<?php echo SITE_PATH; ?>img/banner/track-order3.png" alt="toop"><!--<i class="fa fa-truck"></i>-->
									</div>
									
                                    <div class="single-services-content">
										<h2 style="color:#000000;">Track Order</h2>
									
					<a href="#" ><button class="btn custom-button" name="login" type="submit">Discover more</button>
                    </a>
					...
					<div class="single-services-icon">
										<img src="<?php echo SITE_PATH; ?>img/banner/cancel-order.png" alt="toop"><!--<i class="fa fa-truck"></i>-->
									</div>
									
                                    <div class="single-services-content">
										<h2 style="color:#000000;">Order Cancellation</h2>
									
					<a href="<?php echo SITE_PATH; ?>order_cancel.php" ><button class="btn custom-button" name="login" type="submit">Discover more</button>
                    </a>
					...
					<div class="single-services-icon">
									<img src="<?php echo SITE_PATH; ?>img/banner/return_order.png" alt="toop">	<!--<i class="fa fa-thumbs-o-up"></i>-->
									</div>
									<div class="single-services-content">
										<h2 style="color:#000000;">Return Order</h2>
										<div class="subscribe-action">
						<a href="" >				   	<button class="btn custom-button" name="login" type="submit">Discover more</button>
						</a>	
										<!--<p>Pay on receiving you package<a class="btn custom-button" href="">Discover more</a></p>-->
