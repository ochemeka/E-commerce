								...
								<div class="tab-bar">
									<div class="tab-bar-inner">
										<ul class="nav nav-tabs" role="tablist">
											<li ><a href="#shop-product" data-toggle="tab"><i class="fa fa-th-large"></i></a></li>
											<li class="active"><a href="#shop-list" data-toggle="tab"><i class="fa fa-th-list"></i></a></li>
			<!--<li class="active"><a href="#shop-list" data-toggle="tab"><i class="fa fa-th-list"></i></a></li>-->
            							</ul>
									</div>
									<div class="toolbar">
								...
								<div class="tab-content">
									...
									<div class="tab-pane" id="shop-product">
										...
										<div class="tab-single-product">
											...
											<!-- Single Product -->
											<?php /*?><div class="singel-product single-product-col">
												<div class="label-pro-new">New</div>
												<!-- Single Product Image -->
												<div class="single-product-img">
										...
										</div><!-- End Tab Single Product--><?php */?>
										<!-- Tab Single Product-->
										<?php /*?><div class="tab-single-product">
											...
											<?php /*?><div class="singel-product single-product-col">
												...
												<!-- Single Product Image -->
												<div class="single-product-img">
													<a href="#"><img src="img/products/s7.jpg" alt="product"></a>
												</div>
												<!-- Single Product Content -->
												<div class="single-product-content">
										...
										<div class="tab-single-product">
											...
											<div class="singel-product single-product-col">
												...
												<!-- Single Product Image -->
												<div class="single-product-img">
													<a href="#"><img src="img/products/s8.jpg" alt="product"></a>
												</div>
												<!-- Single Product Content -->
												<div class="single-product-content">
													<h2 class="product-name"><a title="Proin lectus ipsum" href="product-details.html">Proin lectus ipsum</a></h2>
								...
								<!-- Tab Bar -->
								<?php /*?><div class="tab-bar tab-bar-bottom">
									<div class="toolbar">
										<div class="sorter">
											<div class="sort-by">
												<label>Sort By</label>
...
<!-- Mirrored from devitems.com/tf/selphy-preview/selphy/shop-list.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 27 Jul 2016 08:11:58 GMT -->
</html>
