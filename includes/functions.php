...
function get_gal_id($gal){
	...
	/*new*/
	function get_productbyid($product){
	global $connection;
	$query = "SELECT * 
				FROM products  
				WHERE id = '{$product}'   
