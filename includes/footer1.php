					...
					<div class="single-footer-static">
						...
						<div class="footer-static-content">
							<!--<ul>
								...
								<li><a href="compensation">Compensation First</a></li>
					...
					<div class="single-footer-static static-shipping">
						...
						<div class="footer-static-content">
							<!--<ul>	
								...
								<li><a href="map">Locations We Ship To</a></li>
								<li><a href="delvtime">Estimated Delivery Time</a></li>
							</ul>-->
						</div>
					</div><!-- End Single Footer Static -->
					<!-- Single Footer Static -->
					...
					<div class="single-footer-static static-contact">
						...
						<div class="footer-static-content">							
							<!--<div class="contact-info">
								<p class="phone">Phone: 1-860-924-2030</p>
								<p class="email">Email: nigeriafoodmarket@gmail.com</p>
				...
				<div class="container">
					<div class="row">
						<div class="col-md-6">
							<!-- Copyright -->
							<div class="copyright">
								<p>Copyright &copy; 2019-2021 Nigeria Food Market</a> All Rights Reserved.</p>
							</div>						
						</div>
						<div class="col-md-6">
							<!-- Footer Payment -->
...
<!-- Mirrored from devitems.com/tf/selphy-preview/selphy/index-4.php by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 27 Jul 2016 08:11:56 GMT -->
</html>
