...
?>
<?php
$pagetitle="Nigeria Food Market: Local Food Items, Provision and ready made meal::  Helpcentre";
?>
						...
						<div class="shop-product-view">
							...
							<div class="shop-category-image">
                                    <div class="featured-product-area">
                                           ...
                                           <img  src="<?php echo SITE_PATH; ?>img/banner/cancel_order" alt="banner">
                                            <!-- <h1 style="color:#000;"> <strong>HOW TO CANCEL YOUR ORDER</strong></h1>-->
                                            
                                            </div>
                                     </div>
							</div>
                            
                            <div style="color:#000;" align="left" class="shop-category-image">
                                    <div class="featured-product-area">
                                            <div class="featured-product-title"><br /><br /><br />
                                            <!--<img src="img/banner/banner-grid2.png" alt="banner">-->
                                            <!--<img  src="img/banner/call_s.jpg" alt="banner">-->
                                            <h3 style="color:#000;">
                                            FREQUENTLY ASKED QUESTIONS </h3>
<h5 style="color:#FE9900;"><strong>Can I cancel my order?</strong><br /></h5>

Yes, you can cancel your order when it is in <strong>Order In Progress</strong>. Please note that once orders is in <strong>shipped</strong> status it cannot be canceled.<br /><br />

<h5 style="color:#FE9900;"><strong>How long will it take my refund to be processed</strong> <br /></h5>

If your returned order is confirmed, we will proceed with the refund within 7 days and notify you. Your refund will be credited to your E-wallet account. You can either use the it to make a new purchase or withdraw it into a bank account.
<br /><br />
			...
			<div class="container">
               ...
               <h1> <strong>STEPS TO CANCEL ORDERS</strong> </h1>
					...
					<div class="col-md-4">
									...
									<div class="single-services-content">
										<h2 style="color:#FE9900;">1.&nbsp;&nbsp; Select Orders</h2>
										
										<div class="subscribe-action">
										<p> From the list of Orders in your Account, Click  <strong>Product Details</strong> in front of the order you wish to cancel.</p>
				...
				<!--	<div class="single-services-icon">
										<img src="img/\banner\track-order3.png" alt="toop"><i class="fa fa-truck"></i>
									</div> -->
									
                                    <div class="single-services-content">
										<h2 style="color:#000000;">2.&nbsp;&nbsp;Select Cancel</h2>
					<p>
                    From view product details, select <strong>Cancel Order</strong>
                    </p>				
					<!--<a href="order_cancel.php" ><button class="btn custom-button" name="login" type="submit">Discover more</button>
                    </a>-->
								
										<!--<p>Pay on receiving you package<a class="btn custom-button" href="">Discover more</a></p>-->	
									</div>
					...
					<div class="single-services-icon">
									<!--	<img src="img/\banner\cancel-order.png" alt="toop"><i class="fa fa-truck"></i>-->
									</div>
									
                                    <div class="single-services-content">
										<h2 style="color:#FE9900;">2.&nbsp;&nbsp;State Cancellation Reasons <!--Confirm Order  and Submit--> </h2>
									
					<p>
                    State the reasons why you want to cancel order.
					...
					<div class="single-services-icon">
								<!--	<img src="img/\banner\return order.png" alt="toop">	<i class="fa fa-thumbs-o-up"></i>-->
									</div>
									<div class="single-services-content">
										<h2 style="color:#FE9900;">3.&nbsp;&nbsp;Confirm Order Cancellation and Submit </h2>
									
					<p>
                    Select the right quantity you want to cancel and <strong>Submit</strong>.
					...
					<div class="row">
						...
						<div class="col-md-6">
							...
							<div class="footer-payment">
								<a href="#"><img src="<?php echo SITE_PATH; ?>img/logo/payment.png" alt=""></a>
							</div>
						</div>
					</div>
				</div>
							...
							<div class="modal-product">
								<div class="product-images">
									<div class="main-image images">
										<img alt="product" src="<?php echo SITE_PATH; ?>img/products/s1.jpg">
									</div>
