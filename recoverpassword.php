...
<?php
//$pagetitle="Login";
$pagetitle="Nigeria Food Market: Local Food Items, Provision and ready made meal::Login";
?>
				...
				<div class="row">
					<div class="col-md-12">
						<div align="center" class="page-title">
							<h3 style="color:#000000;"> Password Recovery</h3>
							...
							<div class="customer-inner">
								...
								<div class="account-form">
									...
									<!--	<div class="form-goroup">
										...
										<input class="btn custom-button" type="submit" name="login" value="Submit">
									</form>
								</div>
