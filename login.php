				...
				<div class="row">
					...
					<div class="col-md-8 col-sm-8">
						<div class="resestered-customers customer">
							<div class="customer-inner">
								<div class="user-title">
									<h2><i class="fa fa-file-text"></i>Login </h2>
								</div>
								<div class="user-content">
                             ...
                             <div class="user-bottom fix">
								<div class="user-bottom-inner">
									...
									<button class="btn custom-button" name="login" type="submit">login</button>
								</div>
							</div>
                                 <!-- <input class="btn custom-button" type="submit" name="login" value="Log In">-->      
