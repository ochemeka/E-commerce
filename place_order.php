...
<?php include ("includes/header_prod.php") ;?>
		...
		<div class="shop-product-area">
					...
					<div class="col-md-12 col-sm-12">
						...
						<div class="shop-product-view">
							...
							<div class="featured-product-area">
								...
								<img  src="<?php echo SITE_PATH; ?>img/banner/placeorder.jpg"  oncontextMenu = "return false" alt="banner">
								</div></div>
							</div>
			...
			<div class="container">
				<div class="row">
					...
					<div class="single-services-icon">
									...
									<div class="single-services-content">
										<h2>Place Order</h2>
										<p>All Orders are placed in your cart</p>
									</div>
				...
				<!--						-->
					...
					<div class="single-services-icon">
										<img src="<?php echo SITE_PATH; ?>img/banner/track-order3.png" alt="track">
									</div>
									<div class="single-services-content">
										<h2>Track Order</h2>
					...
					<div class="single-services-icon">
										<img src="img/banner/location.png" alt="toop">
									</div>
									<div class="single-services-content">
										<h2>Free delivery</h2>
										<p>Deliver to your desired destination </p>
									</div>
		...
		<!-- Simple Lence JS
		============================================ -->
		<script type="<?php echo SITE_PATH; ?>text/javascript" src="js/jquery.simpleGallery.min.js"></script>
		<script type="<?php echo SITE_PATH; ?>text/javascript" src="js/jquery.simpleLens.min.js"></script>	
		<!-- owl.carousel JS
		============================================ -->		
