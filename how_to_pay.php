		...
		<div class="shop-product-area">
					...
					<div class="col-md-12 col-sm-12">
						...
						<div class="shop-product-view">
							...
							<div class="featured-product-area">
								...
								<img  src="img/banner/mastercard.jpg" alt="banner">
								</div></div>
							</div>
			...
			<div class="container">
				<div class="row">
					...
					<div class="single-services-icon">
									...
									<div class="single-services-content">
										<h2 style="color:#000000;">Pay with your card through</h2>
										
										<div class="subscribe-action">
										<a href="" >  	<button class="btn custom-button" name="login" type="submit">Discover more</button></a>
				...
				<!--						-->
					...
					<div class="single-services-icon">
										<img src="img/\banner\pay-on-delivery.png" alt="toop"><!--<i class="fa fa-truck"></i>-->
									</div>
									
                                    <div class="single-services-content">
										<h2 style="color:#000000;">Pay On Delivery</h2>
					...
					<div class="single-services-icon">
									...
									<div class="single-services-content">
										<h2 style="color:#000000;">Free delivery</h2>
										<div class="subscribe-action">
						<a href="" >				   	<button class="btn custom-button" name="login" type="submit">Discover more</button>
						</a>	
										<!--<p>Pay on receiving you package<a class="btn custom-button" href="">Discover more</a></p>-->
